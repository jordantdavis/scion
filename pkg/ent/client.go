...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.HubSetting, c.InviteCode, c.LifecycleHook, c.LifecycleHookAgentPhase,
...
type (
	hooks struct {
		...
		GroupMembership, HarnessConfig, HubSetting, InviteCode, LifecycleHook,
		...
		Secret, Skill, SkillVersion, SubscriptionTemplate, Template, User,
